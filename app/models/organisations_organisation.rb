...
#    validates :status, presence: true
  belongs_to :organisation_1, :class_name => "Document", :foreign_key => "organisation_1_id"
  belongs_to :organisation_2, :class_name => "Document", :foreign_key => "organisation_2_id"
