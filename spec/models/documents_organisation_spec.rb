...
RSpec.describe DocumentsOrganisation, type: :model do
  
  describe 'Validations'
  subject {FactoryGirl.build(:documents_organisation)}
  ...
  it 'has a valid factory' do
    expect(build(:documents_organisation)).to be_valid
  end
  it 'is invalid without a start_date' do
    expect(build(:documents_organisation, started_at: nil)).to_not be_valid
  end
