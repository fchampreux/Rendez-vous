...
ActiveRecord::Schema.define(version: 20170313054952) do
  ...
  create_table "actions", id: :serial, force: :cascade do |t|
    ...
    t.index ["due_at"], name: "actions_idx_due"
    t.index ["is_planned", "planned_at"], name: "actions_idx_planned"
    t.index ["mode_id"], name: "actions_idx_mode"
    t.index ["name"], name: "actions_idx_name"
    t.index ["priority_id"], name: "actions_idx_priority"
    t.index ["status_id"], name: "actions_idx_status"
  end
  ...
  create_table "actions_actions", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action_1_id", "is_main_relation"], name: "actions_action_1_idx"
    t.index ["action_2_id", "is_main_relation"], name: "actions_action_2_idx"
  end
  ...
  create_table "actions_members", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action_id", "is_main_relation"], name: "actions_members_idx"
    t.index ["member_id", "is_main_relation"], name: "members_actions_idx"
  end
  ...
  create_table "actions_organisations", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action_id", "is_main_relation"], name: "actions_organisations_idx"
    t.index ["organisation_id", "is_main_relation"], name: "organisations_actions_idx"
  end
  ...
  create_table "addresses", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["entity_type", "entity_id"], name: "addresses_idx"
  end

  create_table "chronos", id: :serial, force: :cascade do |t|
    t.string "name", limit: 100, null: false
  ...
  create_table "documents", id: :serial, force: :cascade do |t|
    ...
    t.string "updated_by", limit: 100, null: false
    t.string "session_id", limit: 100, null: false
    t.index ["chrono"], name: "documents_idx_chrono"
    t.index ["code"], name: "documents_idx_code"
    t.index ["is_template"], name: "documents_idx_template"
    t.index ["name"], name: "documents_idx_name"
  end
  ...
  create_table "documents_actions", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action_id", "is_main_relation"], name: "actions_documents_idx"
    t.index ["document_id", "is_main_relation"], name: "documents_actions_idx"
  end
  ...
  create_table "documents_documents", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["document_1_id", "is_main_relation"], name: "documents_documents_1_idx"
    t.index ["document_2_id", "is_main_relation"], name: "documents_documents_2_idx"
  end
  ...
  create_table "documents_members", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["document_id", "is_main_relation"], name: "documents_members_idx"
    t.index ["member_id", "is_main_relation"], name: "members_documents_idx"
  end
  ...
  create_table "documents_organisations", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["document_id", "is_main_relation"], name: "documents_organisations_idx"
    t.index ["organisation_id", "is_main_relation"], name: "organisations_documents_idx"
  end
  ...
  create_table "documents_projects", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["document_id", "is_main_relation"], name: "documents_projects_idx"
    t.index ["project_id", "is_main_relation"], name: "projects_documents_idx"
  end
  ...
  create_table "items", id: :serial, force: :cascade do |t|
    ...
    t.string "updated_by", limit: 100, null: false
    t.string "session_id", limit: 100, null: false
    t.index ["code"], name: "items_idx_code"
    t.index ["item_type_id"], name: "items_idx_type"
    t.index ["name"], name: "items_idx_name"
  end
  ...
  create_table "items_documents", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["document_id", "is_main_relation"], name: "documents_items_idx"
    t.index ["item_id", "is_main_relation"], name: "items_documents_idx"
  end
  ...
  create_table "items_items", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_1_id", "is_main_relation"], name: "items_items_1_idx"
    t.index ["item_2_id", "is_main_relation"], name: "items_items_2_idx"
  end
  ...
  create_table "items_projects", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id", "is_main_relation"], name: "items_projects_idx"
    t.index ["project_id", "is_main_relation"], name: "projects_items_idx"
  end

  create_table "leads_imports", id: :serial, force: :cascade do |t|
    ...
    t.string "updated_by", limit: 100, null: false
    t.string "session_id", limit: 100, null: false
    t.index ["action"], name: "leads_imports_idx_action"
    t.index ["created_at"], name: "leads_imports_idx_created_at"
    t.index ["last_name"], name: "leads_imports_idx_last_name"
    t.index ["org_country", "org_state", "org_city"], name: "leads_imports_idx_geo"
    t.index ["organisation"], name: "leads_imports_idx_organisation"
    t.index ["role"], name: "leads_imports_idx_role"
  end
  ...
  create_table "members", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["first_name"], name: "members_idx_first_name"
    t.index ["last_name"], name: "members_idx_last_name"
  end
  ...
  create_table "members_members", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["member_1_id", "is_main_relation"], name: "members_members_1_idx"
    t.index ["member_2_id", "is_main_relation"], name: "members_members_2_idx"
  end
  ...
  create_table "members_organisations", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["member_id", "is_main_relation"], name: "members_organisations_idx"
    t.index ["organisation_id", "is_main_relation"], name: "organisations_members_idx"
  end
  ...
  create_table "opportunities", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "opportunities_idx_code"
    t.index ["item_id", "is_main_relation"], name: "opportunities_idx_items"
    t.index ["member_id", "is_main_relation"], name: "opportunities_idx_members"
    t.index ["name"], name: "opportunities_idx_name"
  end
  ...
  create_table "organisations", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "organisations_idx_code"
    t.index ["name"], name: "organisations_idx_name"
  end
  ...
  create_table "organisations_organisations", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["organisation_1_id", "is_main_relation"], name: "organisations_organistations_1_idx"
    t.index ["organisation_2_id", "is_main_relation"], name: "organisations_organistations_2_idx"
  end
  ...
  create_table "parameters", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code", "user_id", "language"], name: "parameters_idx", unique: true
  end
  ...
  create_table "parameters_lists", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code", "user_id", "language"], name: "parameters_lists_idx", unique: true
  end
  ...
  create_table "phones", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["entity_type", "entity_id"], name: "phones_idx"
  end
  ...
  create_table "projects", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "projects_idx_code"
    t.index ["name"], name: "projects_idx_name"
  end
  ...
  create_table "projects_actions", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action_id", "is_main_relation"], name: "actions_projects_idx"
    t.index ["project_id", "is_main_relation"], name: "projects_actions_idx"
  end
  ...
  create_table "projects_members", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["member_id", "is_main_relation"], name: "members_projects_idx"
    t.index ["project_id", "is_main_relation"], name: "projects_members_idx"
  end
  ...
  create_table "projects_organisations", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["organisation_id", "is_main_relation"], name: "organistations_projects_idx"
    t.index ["project_id", "is_main_relation"], name: "projects_organistations_idx"
  end
  ...
  create_table "projects_projects", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_1_id", "is_main_relation"], name: "projects_projects_1_idx"
    t.index ["project_2_id", "is_main_relation"], name: "projects_projects_2_idx"
  end
  ...
  create_table "users_actions", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["action_id", "is_main_relation"], name: "actions_users_idx"
    t.index ["user_id", "is_main_relation"], name: "users_actions_idx"
  end
  ...
  create_table "users_documents", id: false, force: :cascade do |t|
    ...
    t.index ["user_id", "is_main_relation"], name: "users_documents_idx"
  end
  ...
  create_table "users_projects", id: false, force: :cascade do |t|
    ...
    t.index ["user_id", "is_main_relation"], name: "users_projects_idx"
  end
  ...
  create_table "users_users", id: false, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_1_id", "is_main_relation"], name: "users_users_1_idx"
    t.index ["user_2_id", "is_main_relation"], name: "users_users_2_idx"
  end
