...
ActiveRecord::Schema.define(version: 20160211054855) do
  ...
  create_table "actions", force: :cascade do |t|
    t.string   "name",        limit: 100,                                          null: false
    t.text     "description", limit: 40000000
    t.string   "categories",  limit: 1000                                  # Extends to additional field groups
  ...
  create_table "addresses", force: :cascade do |t|
    t.integer  "address_type_id",                         null: false     # Can be a simple URL, a deliver_to address, a department ...
    ...
    t.string   "entity_type",                             null: false     # Polymorphisme
    t.integer  "entity_id",                   default: 0, null: false     # Polymorphisme
    t.string   "created_by",      limit: 100,             null: false
    t.string   "updated_by",      limit: 100,             null: false
    t.string   "session_id",      limit: 100,             null: false
    t.integer  "owner_id",                    default: 0, null: false
  ...
  create_table "documents", force: :cascade do |t|
    ...
    t.string   "categories",   limit: 1000                                 # Extends to additional field groups
    t.string   "tags",         limit: 1000 
    t.string   "resource",     limit: 1000                                 # Path and name of the document
    t.integer  "media_type_id",           default: 0, null: false          # Identifies the type media
    t.integer  "chrono_id",               default: 0                       # Type chrono stamp applied to the document
    t.boolean  "is_template",             default: false                   # Marks as template document
    t.integer  "status_id",               default: 0, null: false
    t.integer  "owner_id",                default: 0, null: false
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
  ...
  add_index "documents_documents", ["document_id_1", "is_main_relation"], name: "documents_documents_1_idx", using: :btree
  add_index "documents_documents", ["document_id_2", "is_main_relation"], name: "documents_documents_2_idx", using: :btree
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.string   "categories",   limit: 1000                          # Extends to additional field groups
    t.string   "tags",         limit: 1000 
    t.text     "resource",     limit: 1000                          # Path and filename for item image or datasheet
    t.integer  "media_type_id",           default: 0, null: false   # Media type of datasheet
    t.integer  "status_id",               default: 0, null: false
    t.integer  "item_type_id",            default: 0, null: false   # Family, BOM, packaging ...
    t.integer  "owner_id",                default: 0, null: false
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
    t.string   "created_by",  limit: 100,             null: false
  ...
  create_table "opportunities", id: false, force: :cascade do |t|
    ...
    t.integer  "status_id",                        default: 0,     null: false
    t.boolean  "is_main_relation",                 default: false
    t.boolean  "is_tariff",                        default: false                 # Relation between org and item defines a tariff
    t.integer  "organisation_role_id",             default: 0,     null: false
    t.integer  "item_role_id",                     default: 0,     null: false
  ...
  create_table "phones", force: :cascade do |t|
    ...
    t.text     "phone",         limit: 1000
    t.integer  "country_id",                            null: false
    t.string   "entity_type",                           null: false   # Polymorphisme
    t.integer  "entity_id",                             null: false   # Polymorphisme
    t.string   "created_by",    limit: 100,             null: false
    t.string   "updated_by",    limit: 100,             null: false
    t.string   "session_id",    limit: 100,             null: false
    t.integer  "status_id",                 default: 0
